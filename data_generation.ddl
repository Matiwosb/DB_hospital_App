...
-- Insert sample data into the departments table
  INSERT INTO departments (name, building, floor, hospital_id) VALUES
  ...
  ('PSYCH', 'Psychiatric Hospital', 2, 11),
  ('Dermatology', 'Skincare Building', 3, 12),
  ('Oncologist', 'Lab', 2, 13),
  ('Allergy and Immunology', 'Emergency Room', 4, 14),
  ('Anesthesiologist', 'Operating Room', 1, 15),
  ('Endocrinology', 'Scrub Room', 3, 16),
  ('Gynecology', 'Womans Health Center', 6, 17),
  ('Orthopedic Surgery', 'Trauma Center', 2, 18),
  ('Burn Center', 'Trauma Center', 4, 19),
  ('Pathology', 'Lab Center', 3, 20),
  ('Pediatrics', 'Childrens Hospital', 5, 1),
  ('Rehabilitation', 'Recovery Center', 3, 2),
  ('Nursing', 'Nurses Station', 3, 3),
  ('Sleep Medicine', 'ICU', 2, 4),
  ('Urology', 'Scrub Room', 2, 5), 
  ('Endocrinologist', 'MRI Room', 3, 6),
  ('Gastroenterologist', 'Patient Care Facility', 4, 7),
  ('Geriatrician', 'Emergency Room', 3, 8),
  ('Hematologist', 'Emergency Room', 2, 9),
  ('Infectious Diseases', 'Emergency Room', 1, 10),
  ('Nephrologist', 'Emergency Room', 5, 11),
  ('Palliative care doctor', 'Emergency Room', 6, 12),
  ('Physiatrist', 'Emergency Room', 3, 13),
  ('Pulmonologist', 'Emergency Room', 2, 14),
  ('Rheumatologist', 'Emergency Room', 1, 15),
  ('Neonatologist', 'Emergency Room', 2, 16),
  ('Colorectal Surgery', 'Emergency Room', 3, 17),
  ('Vascular Surgery', 'Emergency Room', 4, 18),
  ('Ophthalmologist', 'Emergency Room', 1, 19),
  ('Pathologist', 'Labs', 5, 20),
  ('Podiatrist', 'Emergency Room', 4, 1),
  ('Transplant Surgery', 'Emergency Room', 3, 2),
  ('Reproductive endocrinology',  'Emergency Room', 1, 3),
  ('Information Technologies', 'Emergency Room', 2, 4),
  ('Paramedics', 'Trauma Site', 3, 5),
  ('Nocturnist', 'Emergency Room', 3, 6),
  ('Intern', 'Emergency Room', 4, 7),
  ('First Year Resident', 'School', 5, 8),
  ('Second Year Resident', 'School', 1, 9),
  ('Third Year Resident', 'School', 1, 10),
  ('Fourth Year Resident', 'School', 3, 11),
  ('Fifth Year Resident', 'School', 2, 12),
  ('Chief of Surgery', 'Chiefs Office', 3, 13),
  ('Lunch Lady', 'Cafeteria', 4, 14),
  ('Research Specialist', 'Research facility', 1, 15),
  ('Travel Nurse', 'Helipad', 3, 16),
  ('Physical Therapist', 'Emergency Room', 3, 17),
  ('Diagnosis Specialist', 'Emergency Room', 1, 18),
  ('Primary Care Doctor', 'Doctors Office', 1, 19); 

-- Insert sample data into the practitioners table
INSERT INTO practitioners (name, profession, specialty, department_id) VALUES
    ...
    ('Dr. Dickens', 'Surgeon', 'Trauma', 6),
    ('Dr. Rausch', 'Oncologist', 'Oncology', 7),
    ('Dr. Geary', 'Oncologist', 'Oncology', 8),
    ('Dr. Grissom', 'Oncologist', 'Oncology', 9),
    ('Dr. Karev', 'Oncologist', 'Oncology', 10),
    ('Dr. Bellu', 'Oncologist', 'Oncology', 1),
    ('Dr. Bounto', 'Oncologist', 'Oncology', 2),
    ('Dr. Renton', 'Surgeon', 'Orthopedics', 3),
    ('Dr. Jeanne', 'Surgeon', 'Orthopedics', 4),
    ('Dr. Enzo', 'Dermatologist', 'Dermatology', 5),
    ('Dr. Esper', 'Dermatologist', 'Dermatology', 6),
    ('Dr. Richmonf', 'Dermatologist', 'Dermatology', 7),
    ('Dr. St. Hilaire', 'Dermatologist', 'Dermatology', 8),
    ('Dr. Torname', 'Dermatologist', 'Dermatology', 9),
    ('Dr. McGinn', 'Dermatologist', 'Dermatology', 10),
    ('Dr. Hayes', 'Pathologist', 'Pathology', 1),
    ('Dr. Glynn', 'Pathologist', 'Pathology', 2),
    ('Dr. Desmond', 'Pathologist', 'Pathology', 3),
    ('Dr. Barnett', 'Pathologist', 'Pathology', 4),
    ('Dr. Murphy', 'Surgeon', 'Orthopedics', 5),
    ('Dr. Lumar', 'Ophthalmologist', 'Ophthalmology', 6),
    ('Dr. Holmes', 'Ophthalmologist', 'Ophthalmology', 7),
    ('Dr. Biana', 'Ophthalmologist', 'Ophthalmology', 8),
    ('Dr. Kelso', 'Ophthalmologist', 'Ophthalmology', 9),
    ('Dr. Gray', 'Ophthalmologist', 'Ophthalmology', 10),
    ('Dr. White', 'Ophthalmologist', 'Ophthalmology', 1),
    ('Dr. Black', 'Ophthalmologist', 'Ophthalmology', 2),
    ('Dr. Jamison', 'Neurologist', 'Neurology', 3),
    ('Dr. Frank', 'Neonatology', 'Neonatologist', 4),
    ('Dr. Levine', 'Neonatology', 'Neonatologist', 5),
    ('Dr. Farsky', 'Neonatology', 'Neonatologist', 6),
    ('Dr. Cunningham', 'Neonatology', 'Neonatologist', 7),
    ('Dr. Boniol', 'Neonatology', 'Neonatologist', 8),
    ('Dr. Wilson', 'Neonatology', 'Neonatologist', 9),
    ('Dr. Jordan', 'Rheumatology', 'Rheumatologist', 10),
    ('Dr. George', 'Rheumatology', 'Rheumatologist', 1),
    ('Dr. Hamilton', 'Rheumatology', 'Rheumatologist', 2),
    ('Dr. Deluca', 'Rheumatology', 'Rheumatologist', 3),
    ('Dr. Helm', 'Rheumatology', 'Rheumatologist', 4),
    ('Dr. Harambe', 'Rheumatology', 'Rheumatologist', 5),
    ('Dr. Mender', 'Pulmonology', 'Pulmonologist', 6),
    ('Dr. Bork', 'Pulmonology', 'Pulmonologist', 7),
    ('Dr. Landon', 'Pulmonology', 'Pulmonologist', 8),
    ('Dr. Jones', 'Pulmonology', 'Pulmonologist', 9),
    ('Dr. France', 'Pulmonology', 'Pulmonologist', 10),
    ('Dr. Fork', 'Pulmonology', 'Pulmonologist', 1),
    ('Dr. James', 'Pulmonology', 'Pulmonologist', 2),
    ('Dr. Pena', 'Surgeon', 'ENT', 3),
    ('Dr. Diamond', 'Surgeon', 'ENT', 4),
    ('Dr. Henderson', 'Surgeon', 'ENT', 5),
    ('Dr. Russo', 'Surgeon', 'ENT', 6),
    ('Dr. Cardenes', 'Surgeon', 'ENT', 7),
    ('Dr. Patel', 'Surgeon', 'ENT', 8),
    ('Dr. Mulry', 'Surgeon', 'General', 9),
    ('Dr. Sanddown', 'Resident', 'Cardiology', 10),
    ('Dr. Windham', 'Resident', 'Pathology', 1),
    ('Dr. Pelham', 'Resident', 'Radiology', 2),
    ('Dr. Methuen', 'Resident', 'Oncology', 3),
    ('Dr. Derry', 'Cheif', 'Radiology', 4),
    ('Dr. Nash', 'Cheif', 'Orthopedics', 5),
    ('Dr. Boston', 'Chief', 'Pediatrics', 6),
    ('Dr. Haverhill', 'Intern', 'Oncology', 7),
    ('Dr. Salem', 'Intern', 'Pathology', 8),
    ('Dr. Lowell', 'Intern', 'Orthopedics', 9),
    ('Dr. Foreman', 'Pathologist', 'Pathology', 10),
    ('Dr. Burke', 'Radiologist', 'Radiology', 1);
...
INSERT INTO patients (first_name, last_name, birthdate, gender, diagnosis, triage) VALUES
    ...
    ('Michael', 'Jackson', '1922-11-04', 'Male', 'Fractured Arm', 'Numbness in Fingers'),
    ('Kimberly', 'Lopez', '1905-03-03', 'Female', 'Fractured Arm', 'Numbness in Fingers'),
    ...
    ('Nick', 'Harris', '1990-09-30', 'Male', 'Migraines', 'Sneezing'),
